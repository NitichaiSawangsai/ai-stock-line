# AI Stock Risk Notification System
...
### 🤖 AI Analysis
- ใช้ ChatGPT ในการวิเคราะห์ข่าว
...
```
ประเภท ชื่อ หน่วยที่ลงทุน ชื่อหุ้น/ชื่อเหรียญคริปโต/ทอง/สกุลเงิน
หุ้น VOO 0.00394415
ทอง ทอง 1 บาท
...
3. **Cost**: การใช้ OpenAI API มีค่าใช้จ่าย
